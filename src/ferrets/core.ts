...
const ferrets = {
  ash: {
    ...
    clips: [
      {
        url: "https://www.twitch.tv/ferretsoftware/clip/OpenBlindingGaurBatChest--A8M0q8UchTyUbIa",
        caption: "Ash says its bedtime",
      },
      {
...
For fun, Shaye allows the ferrets to impart wisdom upon the community. Pickle typed "3bf", and "Zfa".`,
    clips: [
      ...
      {
        url: "https://www.twitch.tv/ferretsoftware/clip/TawdryAnimatedWitchPanicVis-sjfuhx1QsJPWQPxL",
        caption: "Pickle slime time",
      },
      {
